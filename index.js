...
app.get('/Customize-pagodas/:pagodascustomize/:sender_id', function(req, res) {
    ...
    res.render('pagodascustomize.ejs', {
        title: "Customize-Pagodas",
        sender_id: sender_id
    });
});
...
app.get('/Customize/:parks_customize/:sender_id', function(req, res) {
    const sender_id = req.params.sender_id;
    const pagodascustomize = req.params.pagodascustomize;
    res.render('parks_customize.ejs', {
        title: "Customize-Parks",
        sender_id: sender_id
    });
});
...
app.get('/Customize_traditional/:traditional_customize/:sender_id', function(req, res) {
    ...
    res.render('traditional_customize.ejs', {
        title: "Customize-Traditional",
        sender_id: sender_id
    });
});
    ...
    db.collection("Traditional Booking").where("booking_ref", "==", booking_ref)
        ...
        .then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
                ...
                res.render('traditional_update.ejs', {
                    data: data,
                    sender_id: sender_id
                });
...
app.get('/Customize_eatinganddrinking/:eatinganddrinking_customize/:sender_id', function(req, res) {
    ...
    res.render('eatinganddrinking_customize.ejs', {
        title: "Customize-Eating and Drinking",
        sender_id: sender_id
    });
});
    ...
    db.collection("Eating and Drinking Booking").where("booking_ref", "==", booking_ref)
        ...
        .then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
                ...
                res.render('eatinganddrinking_update.ejs', {
                    data: data,
                    sender_id: sender_id
                });
                        ...
                        "attachment": {
                            ...
                            "payload": {
                                ...
                                "elements": [{
                                        ...
                                        "image_url": "https://nolimits.al/wp-content/uploads/2015/04/travel-lot-no-limits-agency-albania.jpg",
...
const showBookingNumber = (sender_psid, ref) => {
    ...
    let response = {
        ...
        "message": {
            "text": `Thanks you!!! Your data is saved and when You aren't ok when you going to trip text this message (Pagodas=Change pago:reference no,Parks=Change parks:reference no,Traditional=Change trad:reference no,Eating and Drinking=Change end:reference no) and your reference is ${ref}`,
        }
    }
...
const update_traditional = (sender_psid, ref_num) => {
    let welcomeMessage = {
        "recipient": {
            "id": sender_psid,
        },
